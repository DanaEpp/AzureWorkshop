...
{
    // This code was originally written from a Microsoft sample
    public static class RetryHelper
    {
        ...
        public static async Task<T> OperationWithBasicRetryAsync<T>(Func<Task<T>> asyncOperation)
        {
            ...
            while(true)
            {
                ...
                // Wait to retry the operation. A better way to delay this would be to see if its a 
                // 429 response code and then use the Retry-After or custom headers to handle this.
                // This will work for this demo though.  
                await Task.Delay(5000 * currentRetry);
            }
        }
